// Getting started: http://docs.seleniumhq.org/docs/03_webdriver.jsp
	...
	import static org.junit.Assert.*;
	 ...
	 public class CrossBrowserTest  {
	    ...
	    static String username = "velbca01%40gmail.com"; // Your username
	    static String authkey = "u3fcbdc394e1d83e";  // Your authkey
	    String testScore = "unset";

	    public static void main(String[] args) throws Exception {
	    	CrossBrowserTest myTest = new CrossBrowserTest();
	        ...
	        try {
	            ...
	            driver.get("http://housingman.com/");
	            ...
	            assertEquals(driver.getTitle(), "Buy Flats In Bangalore | New apartments For Sale in Bangalore | HousingMan Properties For Sale in Bangalore");
